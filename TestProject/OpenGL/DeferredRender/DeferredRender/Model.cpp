...
void Model::LoadModel(string const &path) {
	...
	ProcessNode(scene->mRootNode, scene); //TODO:完全看不懂
}
...
Mesh Model::ProcessMesh(aiMesh* mesh, const aiScene *scene) {
	...
	for (unsigned int i = 0; i < mesh->mNumVertices; i++)
	{
		...
		vector.x = mesh->mVertices[i].x; //todo:不懂
	...
	vector<MeshTexture> normalMaps = LoadMaterialTextures(material, aiTextureType_HEIGHT, "texture_normal"); //TODO:怎么枚举不对应了
